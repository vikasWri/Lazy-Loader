...
*/
(function (a, c) {
    var b = c(jQuery), d = typeof define === "function" && define.amd;
    if (d) {
    ...
    f.jail.prototype.onEvent = function (o) {
        ...
        if (!!o.triggerElement) {
            ...
            n.bind(o.event, {options: o, images: n}, function (s) {
                var r = f(this), q = s.data.options, p = s.data.images;
                k = f.extend({}, p);
                a(q, r);
    ...
    function i(o, n) {
        ...
        if (!!p && typeof p.bind === "function") {
            p.bind(o.event, {options: o, images: n}, m);
            b.resize({options: o, images: n}, m);
        }
    }
    ...
    function m(p) {
        var n = p.data.images, o = p.data.options;
    ...
    function c(q, s, o) {
        var r = f(s), p = (/scroll/i.test(q.event)) ? o.data("triggerEl") : b, n = true;
    ...
    function e(u, n, s) {
        var q = u[0] === window, y = (q ? {top: 0, left: 0} : u.offset()), r = y.top + (q ? u.scrollTop() : 0),
            t = y.left + (q ? u.scrollLeft() : 0), p = t + u.width(), v = r + u.height(), x = n.offset(), w = n.width(),
            o = n.height();
